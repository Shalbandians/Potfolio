...
const Hero = () => {
  ...
  return (
    <section 
      id="hero" 
      className="min-h-screen flex items-center relative overflow-hidden pt-16 sm:pt-20 lg:pt-24 px-4"
    >
      {/* Background animation */}
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-40 h-40 sm:w-64 sm:h-64 bg-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-80 sm:h-80 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 h-56 sm:w-96 sm:h-96 bg-green-500/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="container mx-auto px-2 sm:px-4 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          {/* Left Side */}
          <div className="text-center lg:text-left max-w-2xl animate-fade-in w-full">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-3 sm:mb-4 animate-slide-up leading-tight">
              Muhammad Rizwan
            </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-blue-300 mb-4 sm:mb-6 h-10 sm:h-12 animate-slide-up delay-200">
              {typedText}
              <span className="animate-pulse">|</span>
            </h2>
            
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 mb-6 sm:mb-8 animate-slide-up delay-400 px-2 sm:px-0">
             Passionate MERN developer skilled in MongoDB, Express, React, and Node.js.
Creating impactful and modern web experiences.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start items-center mb-8 sm:mb-12 animate-slide-up delay-600">
              <a
                href={cvFile}
                download="Muhammad_Rizwan_Resume.pdf" 
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base
                           hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 group flex items-center w-full sm:w-auto justify-center"
              >
            ...
            <div className="flex gap-4 sm:gap-6 justify-center lg:justify-start mb-8 sm:mb-12 animate-slide-up delay-800">
              <a href="https://github.com/Shalbandians" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 hover:-translate-y-1">
          ...
          {/* Right Side (Profile Image) */}
          <div className="w-48 sm:w-64 md:w-80 lg:w-[420px] rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 p-1.5 sm:p-2 shadow-2xl 
                          animate-float hover:scale-105 transition-transform duration-500 flex-shrink-0">
            <div className="w-full h-full rounded-2xl bg-slate-900 flex items-center justify-center overflow-hidden">
              <img
                src={profileImage}
                alt="Muhammad Rizwan"
